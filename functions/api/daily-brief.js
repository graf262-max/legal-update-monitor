...
async function collectLawGoKr(env) {
    ...
    try {
        ...
        return items;
    } catch (e) { console.error('[law.go.kr]', e); return []; }
}
...
async function collectAssembly(env) {
    ...
    try {
        ...
        return items;
    } catch (e) { console.error('[assembly]', e); return []; }
}
...
async function collectMoel() {
    try {
        ...
        return items;
    } catch (e) { console.error('[moel]', e); return []; }
}
...
async function collectFtc() {
    try {
        ...
        return items;
    } catch (e) { console.error('[ftc]', e); return []; }
}
...
async function collectPipc() {
    try {
        ...
        for (const m of matches) {
            ...
            if (matched || isPipc) {
                const item = {
                    ...
                    law: law?.name || '개인정보 관련 법령', pubDate: '',
        ...
        return items;
    } catch (e) { console.error('[pipc]', e); return []; }
}
...
async function collectMsit() {
    try {
        ...
        return items;
    } catch (e) { console.error('[msit]', e); return []; }
}
